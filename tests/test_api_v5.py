"""Tests for test_api_v5 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV5Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v5", "version": 3, "batch_size": 96}
