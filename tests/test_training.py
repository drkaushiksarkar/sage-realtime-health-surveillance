"""Tests for test_training -- sage_realtime_health_surveillance."""
import pytest
import torch
...
def test_config():
    ...
    assert config["version"] == 2, "config should expose expected version"
...
@pytest.mark.parametrize("batch_size", [6, 14])
