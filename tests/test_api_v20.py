"""Tests for test_api_v20 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV20Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v20", "version": 3, "batch_size": 96}
...
class TestTestApiV20Processing:
