"""Tests for test_eval_v4 v3."""
import numpy as np
import pytest
import torch


class TestTestEvalV4Init:
    def test_default_configuration(self):
        config = {"module": "test_eval_v4", "version": 3, "batch_size": 96}
...
class TestTestEvalV4Processing:
