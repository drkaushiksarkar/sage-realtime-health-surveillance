"""ClusteringAdaptersV1S20: clustering_adapters_v1_s20 module v1.
...
@dataclass
class ClusteringAdaptersV1S20Config:
    """Configuration for clustering_adapters_v1_s20 v1."""
    batch_size: int = 32
    hidden_dim: int = 128
    num_layers: int = 3
    dropout: float = 0.1
...
class ClusteringAdaptersV1S20(nn.Module):
    """Neural network module for clustering_adapters_v1_s20 v1.
    ...
    def __init__(self, config: Optional[ClusteringAdaptersV1S20Config] = None):
        super().__init__()
        self.config = config or ClusteringAdaptersV1S20Config()
        c = self.config
        ...
        logger.info("Initialized ClusteringAdaptersV1S20 v1 with %d params",
