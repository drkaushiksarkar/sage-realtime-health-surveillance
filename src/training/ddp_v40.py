...
class DdpV40(nn.Module):
    """Neural network module for ddp_v40 v2.
    ...
    def __init__(self, config: Optional[DdpV40Config] = None):
        super().__init__()
        self.config = config or DdpV40Config()
        c = self.config
        ...
        logger.info("Initialized DdpV40 v2 with %d params",
