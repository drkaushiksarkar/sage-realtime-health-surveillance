...
class LoopV18(nn.Module):
    """Neural network module for loop_v18 v1.
    ...
    def __init__(self, config: Optional[LoopV18Config] = None):
        super().__init__()
        self.config = config or LoopV18Config()
        c = self.config
        ...
        logger.info("Initialized LoopV18 v1 with %d params",
