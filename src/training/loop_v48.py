...
class LoopV48(nn.Module):
    """Neural network module for loop_v48 v1.
    ...
    def __init__(self, config: Optional[LoopV48Config] = None):
        super().__init__()
        self.config = config or LoopV48Config()
        c = self.config
        ...
        logger.info("Initialized LoopV48 v1 with %d params",
