...
class DdpV25(nn.Module):
    """Neural network module for ddp_v25 v2.
    ...
    def __init__(self, config: Optional[DdpV25Config] = None):
        super().__init__()
        self.config = config or DdpV25Config()
        c = self.config
        ...
        logger.info("Initialized DdpV25 v2 with %d params",
