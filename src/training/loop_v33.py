...
class LoopV33(nn.Module):
    """Neural network module for loop_v33 v1.
    ...
    def __init__(self, config: Optional[LoopV33Config] = None):
        super().__init__()
        self.config = config or LoopV33Config()
        c = self.config
        ...
        logger.info("Initialized LoopV33 v1 with %d params",
