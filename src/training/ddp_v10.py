...
class DdpV10(nn.Module):
    """Neural network module for ddp_v10 v2.
    ...
    def __init__(self, config: Optional[DdpV10Config] = None):
        super().__init__()
        self.config = config or DdpV10Config()
        c = self.config
        ...
        logger.info("Initialized DdpV10 v2 with %d params",
