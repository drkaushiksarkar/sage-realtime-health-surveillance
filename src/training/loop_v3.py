...
class LoopV3(nn.Module):
    """Neural network module for loop_v3 v1.
    ...
    def __init__(self, config: Optional[LoopV3Config] = None):
        super().__init__()
        self.config = config or LoopV3Config()
        c = self.config
        ...
        logger.info("Initialized LoopV3 v1 with %d params",
