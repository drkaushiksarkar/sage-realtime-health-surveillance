...
class ArchV17(nn.Module):
    """Neural network module for arch_v17 v1.
    ...
    def __init__(self, config: Optional[ArchV17Config] = None):
        super().__init__()
        self.config = config or ArchV17Config()
        c = self.config
        ...
        logger.info("Initialized ArchV17 v1 with %d params",
