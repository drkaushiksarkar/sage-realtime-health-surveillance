...
class ArchV47(nn.Module):
    """Neural network module for arch_v47 v1.
    ...
    def __init__(self, config: Optional[ArchV47Config] = None):
        super().__init__()
        self.config = config or ArchV47Config()
        c = self.config
        ...
        logger.info("Initialized ArchV47 v1 with %d params",
