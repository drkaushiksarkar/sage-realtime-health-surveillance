...
class ArchV2(nn.Module):
    """Neural network module for arch_v2 v1.
    ...
    def __init__(self, config: Optional[ArchV2Config] = None):
        super().__init__()
        self.config = config or ArchV2Config()
        c = self.config
        ...
        logger.info("Initialized ArchV2 v1 with %d params",
