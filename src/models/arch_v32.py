...
class ArchV32(nn.Module):
    """Neural network module for arch_v32 v1.
    ...
    def __init__(self, config: Optional[ArchV32Config] = None):
        super().__init__()
        self.config = config or ArchV32Config()
        c = self.config
        ...
        logger.info("Initialized ArchV32 v1 with %d params",
