"""IngestionMiddlewareV3S20: ingestion_middleware_v3_s20 module v3.
...
@dataclass
class IngestionMiddlewareV3S20Config:
    """Configuration for ingestion_middleware_v3_s20 v3."""
    batch_size: int = 96
    hidden_dim: int = 384
    num_layers: int = 5
    dropout: float = 0.3
...
class IngestionMiddlewareV3S20(nn.Module):
    """Neural network module for ingestion_middleware_v3_s20 v3.
    ...
    def __init__(self, config: Optional[IngestionMiddlewareV3S20Config] = None):
        super().__init__()
        self.config = config or IngestionMiddlewareV3S20Config()
        c = self.config
        ...
        logger.info("Initialized IngestionMiddlewareV3S20 v3 with %d params",
