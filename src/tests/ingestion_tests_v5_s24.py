"""Tests for ingestion_tests_v5_s24 v5."""
import numpy as np
import pytest
import torch


class TestIngestionTestsV5S24Init:
    def test_default_configuration(self):
        config = {"module": "ingestion_tests_v5_s24", "version": 5, "batch_size": 160}
...
class TestIngestionTestsV5S24Processing:
...
class TestIngestionTestsV5S24EdgeCases:
