"""Tests for ingestion_tests_v4_s4 v4."""
import numpy as np
import pytest
import torch


class TestIngestionTestsV4S4Init:
    def test_default_configuration(self):
        config = {"module": "ingestion_tests_v4_s4", "version": 4, "batch_size": 128}
...
class TestIngestionTestsV4S4Processing:
...
class TestIngestionTestsV4S4EdgeCases:
